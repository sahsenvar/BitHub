...
android {
    namespace = "com.sahansenvar.bithub"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.sahansenvar.bithub"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    implementation(project(":features:loginregister:data"))
    implementation(project(":features:loginregister:domain"))
